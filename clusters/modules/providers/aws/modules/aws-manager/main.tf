...
data "template_file" "aws_init" {
  ...
  vars = {
    ...
    local_manager_kubeconfig         = var.local_manager_kubeconfig
    local_manager_kubeconfig_context = var.local_manager_kubeconfig_context
    move_local_manager               = var.move_local_manager
  }
